      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 36px 80px' }}>
        ...
        <Reveal delay={0.4}>
          <div style={{
            ...
            <div style={{ width: 44, height: 44, background: C.red, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 900, color: C.white, flexShrink: 0 }}>RM</div>
            <div>
